...
class Login extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {  username : "admin@tega.com", password : "admin1234" }
                                    ...
                                    <Col lg={9}>
                                        <div>
                                            <div className="text-center">
                                                <div>
                                                    <Link to="/" className="logo"><img src={logodark} alt="logo"/></Link>
                                                </div>
                                            ...
                                            <div className="w-100" id="msg"></div>
                                            <div className="p-2">
